...
public class CustomerController {
    ...
    public ResponseEntity<LoginResponse> customerLogin (@RequestHeader("authorization") final String authorization)throws AuthenticationFailedException {
        ...
        // Calls CustomerService method authenticate to authenticate the login request. if authenticated it returns CustomerAuthEntity with the details as required.
    ...
    and returns a LogoutResponse containing UUID of customer and the successful message.If error returns the error code with corresponding Message.
     */
    @CrossOrigin
